                ...
                {role === "admin" && (
                    <>
                        ...
                        >
                            ...
                            {isOpen && (teachersOpen ? <ChevronDown size={16} /> : <ChevronRight size={16} />)}
                        </div>
                        ...
                        >
                            ...
                            {isOpen && (studentsOpen ? <ChevronDown size={16} /> : <ChevronRight size={16} />)}
                        </div>
                        ...
                        >
                            ...
                            {isOpen && (marksOpen ? <ChevronDown size={16} /> : <ChevronRight size={16} />)}
                        </div>
